...
from attack import default_pgd_loss

def customized_gtrsb_loss(origin_out, output, C_mat, rhs_mat, or_spec_size,
               gama_lambda=0, threshold=-1e-5, mode='hinge', model=None):
    # first return the original loss
    loss, loss_gama = default_pgd_loss(origin_out, output, C_mat, rhs_mat, or_spec_size,
